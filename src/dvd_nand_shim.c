...
static VirtualFileEntry s_FileTable[] = {
    ...
    { "DataWii/Video/ThpPlayerFiles/2nd_time.mid",         12103,    48 },
    { "DataWii/Video/ThpPlayerFiles/gm16adpcm.pcm",        881485,   49 },
    { "DataWii/Video/ThpPlayerFiles/gm16adpcm.wt",         193082,   50 },
    { "DataWii/Wow3.sel",                                  44736,    51 },
    { "DataWii/first.zip",                                 733221,   52 },
    { "DataWii/frontend.zip",                              4594145,  53 },
    { "DataWii/game.zip",                                  8604285,  54 },
    { "DataWii/Video/T17.thp",                             1906912,  55 },
    { "DataWii/Video/THQ.thp",                             3766656,  56 },
};
